 ...
 * @author darts
 */
public class ParametersWar1 extends Parameters{
    private static ParametersWar1 instance;
    ...
    private ParametersWar1() {
        initFrontiers();
        initStatesByRegion();
        initStates();//deve seguir initStatesByRegion()
    }
    
    public static ParametersWar1 getInstance(){
        if (instance == null){
            instance = new ParametersWar1();
        }
        return instance;
    }
